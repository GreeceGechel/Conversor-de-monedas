...
ventanaPrincipal = Frame(root, bg="#FFFF99")
ventanaPrincipal.grid()

#titulo de la raiz
titulo = Label(ventanaPrincipal, text="Convertidor de monedas", font=("Roboto",20,"bold"), bg="#99CCFF", fg="white")
titulo.grid(row=1, column=1, padx=10, columnspan=2)

#Etiqueta moneda actual
titulo = Label(ventanaPrincipal, text="Numero A", font=("Roboto",10,"bold"), bg="#CC99FF", fg="white")
...
#moneda actual
titulo = Label(ventanaPrincipal, text="Valor actual", font=("Roboto",10,"bold"), bg="#CC99FF", fg="white")
...
#moneda a convertir
titulo = Label(ventanaPrincipal, text="Convertir", font=("Roboto",10,"bold"), bg="#CC99FF", fg="white")
...
#etiqueta resultado
titulo = Label(ventanaPrincipal, text="Resultado", font=("Roboto",10,"bold"), bg="#CC99FF", fg="white")
